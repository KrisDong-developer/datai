...
COMMENT ON COLUMN oauth_user.access_token IS '用户的授权Seesion';
COMMENT ON COLUMN oauth_user.expire_in IS '第三方用户的授权Seesion的有效期，部分平台可能没有';
COMMENT ON COLUMN oauth_user.refresh_token IS '刷新Seesion，部分平台可能没有';
