...
CREATE TABLE oauth_user (
    ...
    access_token VARCHAR(255) NOT NULL COMMENT '用户的授权Seesion',
    expire_in INT COMMENT '第三方用户的授权Seesion的有效期，部分平台可能没有',
    refresh_token VARCHAR(255) COMMENT '刷新Seesion，部分平台可能没有',
