...
CREATE TABLE `datai_config_snapshot`  (
  `id` varchar(36) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL COMMENT '快照ID',
  `dept_id` bigint NULL DEFAULT NULL COMMENT '部门ID',
...
CREATE TABLE `datai_config_version`  (
  ...
  `update_time` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '更新时间',
  PRIMARY KEY (`id`) USING BTREE COMMENT '主键索引',
  UNIQUE INDEX `uk_version_number`(`dept_id` ASC, `version_number` ASC) USING BTREE COMMENT '唯一约束',
...
CREATE TABLE `datai_picklist`  (
  ...
  `update_time` datetime NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '更新时间',
  PRIMARY KEY (`id`) USING BTREE,
  UNIQUE INDEX `uk_field_item`(`dept_id` ASC, `object_name` ASC, `field_name` ASC, `item_value` ASC, `lang` ASC) USING BTREE
...
CREATE TABLE `datai_sf_login_statistics`  (
  ...
  `update_time` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '更新时间',
  PRIMARY KEY (`id`) USING BTREE,
  UNIQUE INDEX `uk_stat_dimension`(`dept_id` ASC, `stat_date` ASC, `stat_hour` ASC, `login_type` ASC) USING BTREE,
