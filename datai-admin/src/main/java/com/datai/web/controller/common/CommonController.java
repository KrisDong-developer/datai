package com.datai.web.controller.common;
...
import com.datai.framework.config.ServerConfig;
...
public class CommonController {
    ...
    public void fileDownload(
        ...
        try {
            ...
            String filePath = DataIConfig.getDownloadPath() + fileName;
    ...
    public AjaxResult uploadFiles(@RequestBody List<MultipartFile> files)
        ...
        try {
            // 上传文件路径
            String filePath = DataIConfig.getUploadPath();
