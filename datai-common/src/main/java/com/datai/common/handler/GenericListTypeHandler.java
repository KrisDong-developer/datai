package com.datai.common.handler;
 ...
 *          typeHandler=
"com.datai.generator.handler.GenericListTypeHandler$StringList"/>}
 * 
 * 2. 在字段上使用注解：
 * {@code @Result(column="tags", property="tags", 
 ...
 *
 * 3. 在xml插值语法中使用
 * {@code #{tags,typeHandler=com.datai.common.handler.GenericListTypeHandler$StringList}
 * }
 * 
 * @param <T> 列表元素类型
 */
