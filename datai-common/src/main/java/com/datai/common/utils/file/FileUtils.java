package com.datai.common.utils.file;
...
import com.datai.common.config.DataIConfig;
import com.datai.common.constant.Constants;
import com.datai.common.exception.file.FileSizeLimitExceededException;
import com.datai.common.exception.file.InvalidExtensionException;
import com.datai.common.utils.DateUtils;
import com.datai.common.utils.StringUtils;
import com.datai.common.utils.spring.SpringUtils;
import com.datai.common.utils.uuid.IdUtils;
import com.datai.common.utils.uuid.Seq;
import com.datai.common.utils.uuid.UUID;
...
public class FileUtils {
    ...
    public static final long DEFAULT_MAX_SIZE = Long.valueOf(SpringUtils.getRequiredProperty("datai.fileMaxSize"))
            * 1024 * 1024;
    ...
    public static String writeImportBytes(byte[] data) throws IOException {
        return writeBytes(data, DataIConfig.getImportPath());
    }
    ...
    /**
     * 获取文件名称 /profile/upload/2022/04/16/datai.png -- datai.png
     *
     * @param fileName 路径名称
     * @return 没有文件路径的名称
     */
    ...
    /**
     * 获取不带后缀文件名称 /profile/upload/2022/04/16/datai.png -- datai
     *
     * @param fileName 路径名称
     * @return 没有文件路径和后缀的名称
     */
    ...
    public static final String getPathFileName(String uploadDir, String fileName) throws IOException {
        int dirLastIndex = DataIConfig.getProfile().length() + 1;
