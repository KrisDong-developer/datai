...
import com.datai.common.core.page.PageDomain;
import com.datai.common.core.page.TableSupport;
...
public class PageUtils {
    // 开关：通过系统属性 datai.paging 控制，custom=自研，helper=PageHelper。默认 custom
    ...
    private void init() throws Exception {
        ...
        if ("custom".equals(pageUtilsType)) {
            PROVIDER_CLS = Class.forName("com.datai.mybatisinterceptor.context.page.PageContextHolder");
            SET_REASONABLE = PROVIDER_CLS.getMethod("setReasonable", Boolean.class);
            Class<?> PageInfoClz = Class.forName("com.datai.mybatisinterceptor.context.page.model.TableInfo");
