...
public class DataiConfigSnapshotController extends BaseController
{
    ...
    public AjaxResult getInfo(@PathVariable("snapshotId") String snapshotId)
    {
        return success(dataiConfigSnapshotService.selectDataiConfigSnapshotBySnapshotId(snapshotId));
    }
    ...
    public AjaxResult remove(@PathVariable( name = "snapshotIds" ) String[] snapshotIds) 
    {
        return toAjax(dataiConfigSnapshotService.deleteDataiConfigSnapshotBySnapshotIds(snapshotIds));
    }
}
