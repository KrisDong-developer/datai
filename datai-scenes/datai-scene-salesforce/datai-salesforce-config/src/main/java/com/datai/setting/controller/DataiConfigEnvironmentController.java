...
public class DataiConfigEnvironmentController extends BaseController
{
    ...
    {
        return success(dataiConfigEnvironmentService.selectDataiConfigEnvironmentByEnvironmentId(environmentId));
    }
    ...
    public AjaxResult remove(@PathVariable( name = "environmentIds" ) Long[] environmentIds) 
    {
        return toAjax(dataiConfigEnvironmentService.deleteDataiConfigEnvironmentByEnvironmentIds(environmentIds));
    }
}
